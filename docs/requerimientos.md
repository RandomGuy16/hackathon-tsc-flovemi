...
| RNF-03 | **Mantenibilidad:** el dominio (`domain/`) no importa nada de Next.js ni Supabase — es TypeScript puro y testeable |
| RNF-04 | **Seguridad:** las API keys (latinfo.dev, OEFA, Supabase) solo existen en el servidor, nunca llegan al navegador |
| RNF-05 | **Escalabilidad:** el deploy es serverless en Vercel — sin servidor que administrar |
