...
- Los RUC son cadenas de 11 dígitos (`20100047218`).
...
|---|---|---|
| `search` | string | Texto de búsqueda (mínimo 3 caracteres) |
...
- Si una fuente externa falla, el endpoint sigue respondiendo con los datos disponibles — no retorna error por fuente caída.
- Persona B puede mockear estas respuestas mientras Persona A implementa los endpoints.
